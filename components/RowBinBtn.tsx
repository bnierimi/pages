            ...
            <div className="w-full h-full p-2 md:p-1 bg-zinc-100 dark:bg-zinc-800 backdrop-blur-md rounded-2xl text- shadow-lg md:shadow ">
              ...
              <div className="w-full pt-2 md:pt-0 space-y-3">
                <section className="w-full flex flex-col space-y-1 ">
                  <button className="w-full flex items-center space-x-2 p-2 hover:bg-gray-300 dark:hover:bg-gray-500/20 rounded-xl focus:outline-none focus:ring-1 focus:ring-violet-600 text-sm">
                    <i className="icon icon-ic_fluent_delete_arrow_back_20_regular flex text-lg"></i>
                    <p className="font-medium">Restore page</p>
                  </button>
                </section>
                <section className="w-full flex flex-col space-y-1 ">
                  <button className="w-full flex items-center space-x-2 p-2 text-rose-500 hover:bg-rose-500/20 rounded-xl focus:outline-none focus:ring-1 focus:ring-violet-600 text-sm">
                    <i className="icon icon-ic_fluent_delete_dismiss_20_regular flex text-lg"></i>
